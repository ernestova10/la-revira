...
<head>
    ...
    <title>¿Qué ocurre? - La Revirá</title>
...
<body class="bg-custom-white font-sans text-gray-900">
    ...
    <header class="bg-white border-b border-gray-200">
        ...
        <section class="w-full bg-custom-blue py-0 overflow-hidden">
            <img src="{{ asset('img/queOcurreSS.png') }}" 
                alt="Panorámica Sevilla" 
    ...
    <main class="container mx-auto px-4 py-16 max-w-5xl">
        ...
        <div class="mb-20">
            ...
            <div class="flex flex-col md:flex-row items-center gap-12">
                <p class="text-gray-700 leading-relaxed text-lg flex-1">
                    Las Hermandades y Cofradías son las encargadas de organizar las procesiones durante la Semana Santa. Cada una realiza su estación de penitencia desde su templo, manteniendo tradiciones centenarias y una fuerte vinculación con sus barrios y fieles.
                </p>
                
                <div class="flex-none">
                    <img src="{{ asset('img/hermandadesYcofradias.jpg') }}" 
                        alt="Hermandades y Cofradías"
                        class="rounded-sm shadow-xl w-[472px] h-[268px] object-cover object-center">
                </div>
            </div>
        </div>
        ...
        <div class="mb-20">
            ...
            <div class="flex flex-col md:flex-row-reverse items-center gap-12">
                <p class="text-gray-700 leading-relaxed text-lg flex-1">
                    Los pasos procesionales, que representan escenas de la Pasión, avanzan al ritmo de marchas interpretadas por bandas de música. La combinación de imagen, sonido y silencio crea una experiencia única en las calles de Sevilla.
                </p>
                <div class="flex-1">
                    <img src="{{ asset('img/pasoYmusica.png') }}" class="rounded-sm shadow-xl w-full">
                </div>
            </div>
        </div>
        ...
        <div class="mb-20">
            ...
            <div class="flex flex-col md:flex-row items-center gap-12">
                <p class="text-gray-700 leading-relaxed text-lg flex-1">
                    Los nazarenos acompañan a los pasos portando cirios como símbolo de penitencia, mientras que los costaleros son los encargados de llevarlos sobre sus hombros. Su esfuerzo y coordinación son fundamentales.
                </p>
                <div class="flex-1">
                    <img src="{{ asset('img/nazarenosYcostaleros.png') }}" class="rounded-sm shadow-xl w-full">
                </div>
            </div>
        </div>
        ...
        <div class="mb-20">
            ...
            <div class="flex flex-col md:flex-row-reverse items-center gap-12">
                <p class="text-gray-700 leading-relaxed text-lg flex-1">
                    La Carrera Oficial es el recorrido común por el que pasan todas las hermandades, incluyendo la Catedral de Sevilla. Representa el punto central de la Semana Santa y simboliza la estación de penitencia ante el principal templo de la ciudad.
                </p>
                <div class="flex-1">
                    <img src="{{ asset('img/carreraOficial.jpg') }}" class="rounded-sm shadow-xl w-full">
                </div>
            </div>
        </div>
