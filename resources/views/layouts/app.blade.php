...
<body class="antialiased bg-white flex flex-col min-h-screen">
    ...
    <footer class="bg-[#171E38] text-white py-12">
        <div class="container mx-auto px-4 flex flex-col items-center">
            <p class="text-[11px] text-gray-400 tracking-[0.3em] uppercase text-center">
                © 2026 La Revirá - Sevilla. Todos los derechos reservados.
            </p>

            <div class="flex items-center space-x-10 mt-8">
                <a href="https://www.instagram.com/_lareviradesevilla_/" target="_blank" class="text-gray-400 hover:text-white transition-all hover:scale-125">
                ...
                <a href="https://twitter.com/lareviradesev" target="_blank" class="text-gray-400 hover:text-white transition-all hover:scale-125">
